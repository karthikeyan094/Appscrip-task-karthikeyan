    ...
    return (
      <div className={styles.card}>
        ...
        <div>
          ...
          <p className={styles.texttitle1}>Sign in or Create an account to see pricing</p>
        </div>
      </div>
    );
  });
          ...
          <div className={showFilter ? `${styles.side}` : `${styles.hidden}`}>
            <div className={styles.idealbox}>
              <div className={styles.costomize}>
                ...
                />
                <label htmlFor="">COSTOMIZE</label>
                <br />
              </div>
              <p className={styles.hedingideal} onClick={showideal}>
                IDEAL FOR
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
            ...
            <div className={styles.ocassionbox}>
              <p className={styles.hedingideal} onClick={showocassion}>
                OCASSION
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
              <div
                className={occasion ? `${styles.ideal}` : `${styles.hidden}`}
              >
                ...
                <br />
                <input value="test" type="checkbox" />
                <label htmlFor="">Baby & Kids</label>
                <br />
              </div>
            </div>
            <div className={styles.ocassionbox}>
              <p className={styles.hedingideal} onClick={showwork}>
                WORK
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
            ...
            <div className={styles.ocassionbox}>
              <p className={styles.hedingideal} onClick={showfabrik}>
                FABRIK
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
            ...
            <div className={styles.ocassionbox}>
              <p className={styles.hedingideal} onClick={showsegment}>
                SEGMENT
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
            ...
            <div className={styles.ocassionbox}>
              <p className={styles.hedingideal} onClick={showsuitable}>
                SUITABLE FOR
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
              <div
                className={suitable ? `${styles.ideal}` : `${styles.hidden}`}
              >
                <input value="test" type="checkbox" />
                <label htmlFor="">men</label>
                <br />
            ...
            <div className={styles.ocassionbox}>
              <p className={styles.hedingideal} onClick={showraw}>
                RAW MATERIALS
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
            ...
            <div className={styles.ocassionbox}>
              <p className={styles.hedingideal} onClick={showpattern}>
                PATTERN
              </p>
              <p>All</p>
              {/*here we used conditional rendring and string interpolation*/}
